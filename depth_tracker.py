...
class depth_reader:
    ...
    def tracking(self, frame):
        ...
        if success:
            ...
            cv2.circle(frame, p3,1, (0, 0, 255), 2)
        else:
    ...
    def ImageCallback(self, rgb_data , depth_data):
        ...
        #dc_info = depth_image[self.y+(h/2)][self.x+(w/2)]
        ...
        tracked_img = self.tracking(color_image)
        self.roi_setup = False
